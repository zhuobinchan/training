package com.ehighsun.training.base.action;
...
import com.ehighsun.training.util.PageUtil;
...
public class BaseAction extends ActionSupport {
	...
	public void findPageFunc(){
		...
		pageBean = new PageBean(Integer.parseInt(page), 6);
		...
		String pageCode = PageUtil.genPagination(request.getContextPath()
				...
				Integer.parseInt(page), 6, "mainPage="+mainPage+"&findPageTarget="+findPageTarget+pageCodeParam);
