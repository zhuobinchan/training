...
<body>
	...
	<div id="sidebar">
		<ul>
			...
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
				...
				<ul>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/admin/AdminOrganization_findPage?mainPage=adminOrganization.jsp&findPageTarget=/admin/AdminOrganization_findPage"><i
						class="icon icon-home"></i>机构管理</a></li>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/admin/AdminTeacher_findPage?mainPage=adminTeacher.jsp&findPageTarget=/admin/AdminTeacher_findPage"><i
						class="icon icon-home"></i>教师管理</a></li>
					<li id="addHRLi"><a href="${pageContext.request.contextPath}/admin/AdminStudent_findPage?mainPage=adminStudent.jsp&findPageTarget=/admin/AdminStudent_findPage"><i
			...
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>课程管理</span> <span class="label">2</span></a>
				<ul>
					<li id="addLumpLi"><a href="${pageContext.request.contextPath}/admin/AdminLump_findPage?mainPage=adminLump.jsp&findPageTarget=/admin/AdminLump_findPage"><i
						class="icon icon-home"></i>板块管理</a></li>
					<li id="addCourseLi"><a href="${pageContext.request.contextPath}/admin/AdminCourse_findPage?mainPage=adminCourse.jsp&findPageTarget=/admin/AdminCourse_findPage"><i
						class="icon icon-home"></i>课程管理</a></li>
				</ul>
			</li>
			
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>故事板管理</span> <span class="label">2</span></a>
				<ul>
					<li id="addLumpLi"><a href="${pageContext.request.contextPath}/admin/AdminStory_findPage?mainPage=adminStory.jsp&findPageTarget=/admin/AdminStory_findPage"><i
						class="icon icon-home"></i>故事管理</a></li>
				</ul>
			</li>
		</ul>
