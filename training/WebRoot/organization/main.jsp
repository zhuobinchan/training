	...
	<div id="sidebar">
		<ul>
			...
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>课程管理</span> <span class="label">4</span></a>
				<ul>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/organization/Organization_adminCourse"><i
						class="icon icon-home"></i>课程管理</a></li>
				</ul>
			</li>
			
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>班次管理</span> <span class="label">4</span></a>
				<ul>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/organization/Organization_adminClassTable"><i
						class="icon icon-home"></i>班次管理</a></li>
				</ul>
			</li>
			
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>教师管理</span> <span class="label">4</span></a>
				<ul>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/organization/Organization_getTeachers.action"><i
						class="icon icon-home"></i>查看教师</a></li>				
				</ul>
			</li>
			
			<li class="submenu"><a href="#"><i class="icon icon-th-list"></i>
					<span>机构信息</span> <span class="label">4</span></a>
				<ul>
					<li id="addTeacherLi"><a href="${pageContext.request.contextPath}/admin/TeacherAdminCourse_getObjectById?mainPage=adminTeacherInfo.jsp&findPageTarget=/admin/TeacherAdminCourse_getObjectById"><i
						class="icon icon-home"></i>机构信息</a></li>
				</ul>
			</li>			
		</ul>
